...
public class MCQDAOImpl implements MCQDAO {
	...
	/* (non-Javadoc)
	 * @see net.viralpatel.contact.dao.MCQDAO#addMCQ(net.viralpatel.contact.form.MCQ)
	 */
	...
	/* (non-Javadoc)
	 * @see net.viralpatel.contact.dao.MCQDAO#listMCQs()
	 */
	...
	/* (non-Javadoc)
	 * @see net.viralpatel.contact.dao.MCQDAO#obtainTest(java.lang.String)
	 */
